...
public class MapGenorator extends PApplet {
...
int select;
int keyColors[] = new int[56];
int matchColors[] = new int[56];
...
public int findPos(String name, Boolean x)
{
  int[] _pos = {0, 0};
...
public int findColor(String name)
{
  int _color = color(0, 0, 0);
...
public void draw ()
{
  ...
  public void settings() {  size(1987, 1824); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MapGenorator" };
    if (passedArgs != null) {
